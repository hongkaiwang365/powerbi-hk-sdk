...
class Report
{
    ...
    const REPORT_IN_GROUP_URL_ONE = "https://api.powerbi.com/v1.0/myorg/groups/%s/reports/%s";
    ...
    /**
     * Notes:
     * @author:hongkai - 11/22/2022 10:27 AM
     * @param $groupId
     * @param $reportId
     * @return \Tngnt\PBI\Response
     */
    public function getReportOneInGroup($groupId, $reportId)
    {
        $url = sprintf(self::REPORT_IN_GROUP_URL_ONE, $groupId,$reportId);
